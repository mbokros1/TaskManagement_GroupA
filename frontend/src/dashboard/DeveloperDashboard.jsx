...
const rows = [
    createSampleData('Name #1', 'Description goes here', '2026-01-01', 'Medium', 'To-Do'),
    createSampleData('Name #2', 'Description goes here', '2025-12-01', 'Medium', 'In Review'),
    createSampleData('Name #3', 'Description goes here', '2025-11-01', 'Medium', 'In Review'),
    createSampleData('Name #4', 'Description goes here', '2025-10-01', 'High', 'In Progress'),
    createSampleData('Name #5', 'Description goes here', '2025-05-01', 'Low', 'Completed')
]
        ...
        <Box sx={{ bgcolor: "background.default", minHeight: "100vh"}}>            
            <Box sx={{ py: 3}}>                
                ...
                <Grid container spacing = {2}>
                    ...
                    {/* Recent Activity */}
                    <Box sx={{ bgcolor: "background.default", borderRadius: 2, boxShadow: 1, mb: 2, width: "49.3%", p: 2, boxSizing: "border-box" }}>
                        <Typography variant="h5" fontWeight="bold">
                            Recent Activity
                        </Typography>
                    </Box>
