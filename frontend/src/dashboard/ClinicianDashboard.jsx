...
import {Box, Button, Grid, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Typography } from '@mui/material';
...
const rows = [
    createSampleData('Ticket #1', 'Description goes here', '2026-01-01', 'Submitted', <Button>Leave Comment</Button>),
    createSampleData('Ticket #2', 'Description goes here', '2025-12-01', 'In Review', <Button>Leave Comment</Button>),
    createSampleData('Ticket #3', 'Description goes here', '2025-11-01', 'In Review', <Button>Leave Comment</Button>),
    createSampleData('Ticket #4', 'Description goes here', '2025-10-01', 'In Progress', <Button>Leave Comment</Button>),
    createSampleData('Ticket #5', 'Description goes here', '2025-05-01', 'Completed', <Button>Leave Comment</Button>)
]
